...
print('Stopping server No :\033[36m {} \033[0m   Server Name: \033[35m placeholder \033[0m  Refresh server stats to see status'.format(args.serverNumber) )
print('Stopping server ID No :\033[36m {} \033[0m Refresh server stats to see status'.format(serverDict[args.serverNumber]) )
#print(response)
