...
def find_and_display_numbers():
    ...
    for input_letter in user_input:
        ...
        if not matching_row.empty:
            matching_numbers = matching_row.iloc[0]['numbers']
            matching_results.append(str(int(matching_numbers)))  # Convert to integer
        else:
            matching_results.append("NoMatch")
...
text_widget = tk.Text(root, height=9, width=60)
...
# Create a button to clear input and output
