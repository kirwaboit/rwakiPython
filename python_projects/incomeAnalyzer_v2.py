...
# remove the positive values by converting them to 0
#df1[df1['Amount'] > 0] = 0

for col in df1.columns:
    print(col)

#df1[(df1[['Amount']] > 0.0)] = 0.0
df1['Amount'] = df1['Amount'].where(df1['Amount']<0.0, other=0.0)   # replace positive values


# create  the name of the file
file_name = 'datatoCheck_v8_negativeValues.xlsx'
...
df2 = df1.groupby(df1['Date'].dt.to_period('M')).sum()
