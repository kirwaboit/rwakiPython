...
# Open a file dialog window to select a CSV file
file_path = filedialog.askopenfilename(filetypes=[('CSV files', '*.csv')])

# Load the CSV file into a pandas dataframe
df = pd.read_csv(file_path)

#Alternatively you can also Open a file dialog window to select an excel file


# Create a DataFrame with 3 rows and 3 columns filled with random data
df = pd.DataFrame(np.random.rand(4, 4), columns=['Column1','Column2','Column3','Column4'])
