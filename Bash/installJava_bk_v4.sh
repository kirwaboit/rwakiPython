...
#echo "export PATH=$USER_INSTALL_DIR/bin:$PATH" >> $HOME_DIR/.bashrc && source $HOME_DIR/.bashrc
#echo "export PATH=$USER_INSTALL_DIR/bin:$PATH" >> $HOME_DIR/.bash_profile && source $HOME_DIR/.b#ash_profile
#echo "export PATH=$USER_INSTALL_DIR/bin:$PATH" >> /home/ec2-user/.bashrc && source /home/ec2-user/.bashrc#
echo "export PATH=$USER_INSTALL_DIR/bin:$PATH" >> $HOME_DIR/.bashrc && source $HOME_DIR/.bashrc
